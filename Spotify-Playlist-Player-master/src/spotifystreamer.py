...
with open('{}/src/config.yaml'.format(ROOT_PATH),'r', encoding='utf8') as conf:
    configuration = yaml.load(conf,Loader=any)
...
if configuration['Spotify']['client_id']!= '66ab12a5437c4a5f9558c5810ba546a5' and configuration['Spotify']['client_secret']!='b7b08fce65984fb9a7cadf7bf9853c80':
    Spotify_credentials=True
if configuration['Google_cloud_api_key']!='AIzaSyBhTO2qvSDsNgENuyjEst07PbbzIGnWwmo':
